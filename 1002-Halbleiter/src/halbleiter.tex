...
\newcommand{\co}{\chemel{Co}{57}}
\newcommand{\am}{\chemel{Am}{241}}
...
\url{https://github.com/Bigben37/FP1/tree/master/1002-Halbleiter} abgerufen werden.
\thispagestyle{empty}
...
\input{03_Aufbau_BL}
\input{04_Durchfuerung_BL}
\input{05_Auswertung_BL}

\section{Haynes-Shockley-Experiment}
\input{03_Aufbau_HS}
\input{04_Durchfuerung_HS}
\input{05_Auswertung_HS}

\section{Halbleiterdetektoren}
\input{03_Aufbau_HD}
\input{04_Durchfuerung_HD}
\input{05_Auswertung_HD}
