...
% CONFIG
\newcommand{\exptitle}{Kernspin}       % long name of experiment 
\newcommand{\exptitleshort}{Kernspin} % short name of experiment
\newcommand{\expdate}{13. und 14. Oktober}           % date of experiment
\newcommand{\exptutor}{Philip \textsc{Sommer}}
...
\url{https://github.com/Bigben37/FP1/tree/master/1013-Kernspin} abgerufen werden.
\thispagestyle{empty}
