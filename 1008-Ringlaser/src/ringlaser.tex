...
% CONFIG
\newcommand{\exptitle}{Ringlaser}       % long name of experiment 
\newcommand{\exptitleshort}{Ringlaser} % short name of experiment
\newcommand{\expdate}{8. und 9. Oktober, 2014}           % date of experiment
\newcommand{\exptutor}{Wiebke \textsc{Herzberg}}
...
Alle Python-Skripte, \LaTeX-Skripte, Mathematica-Notebooks und SVG-Graphiken können online unter
\url{https://github.com/Bigben37/FP1/tree/master/1008-Ringlaser} abgerufen werden.
\thispagestyle{empty}
