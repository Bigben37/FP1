...
% CONFIG
\newcommand{\exptitle}{Hanle-Effekt}       % long name of experiment 
\newcommand{\exptitleshort}{Hanle-Effekt} % short name of experiment
\newcommand{\expdate}{16. und 17. Oktober, 2014}           % date of experiment
\newcommand{\exptutor}{Christian \textsc{Schillo}}
...
\url{https://github.com/Bigben37/FP1/tree/master/1016-Hanle} abgerufen werden.
\thispagestyle{empty}
