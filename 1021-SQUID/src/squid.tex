...
% CONFIG
\newcommand{\exptitle}{SQUID}       % long name of experiment 
\newcommand{\exptitleshort}{SQUID} % short name of experiment
\newcommand{\expdate}{21. und 22. Oktober 2014}           % date of experiment
\newcommand{\exptutor}{Adam \textsc{Piechaczek}}
...
\url{https://github.com/Bigben37/FP1/tree/master/1021-SQUID} abgerufen werden.
\thispagestyle{empty}
