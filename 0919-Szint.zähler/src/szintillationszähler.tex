...
\usepackage{textgreek}  %same, maybe :)
...
\newcommand{\na}{\chemel{Na}{22}}
\newcommand{\co}{\chemel{Co}{60}}
\newcommand{\eu}{\chemel{Eu}{152}}
\renewcommand{\th}{\chemel{Th}{228}}
...
\end{itemize}
Die Graphiken wurden mit Inkscape (\url{http://www.inkscape.org}) gezeichnet. \\
Ein Teil der verwendeten Gleichung wurde mit Mathematica 9.0 und 10.0 gelöst.\\[\baselineskip]
Alle Python-Skripte, \LaTeX-Skripte und SVG-Graphiken können online unter \\
\url{https://github.com/Bigben37/FP1/tree/master/0919-Szint.zähler} abgerufen werden.
\thispagestyle{empty}
